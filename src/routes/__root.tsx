...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Personal Trainer — Plataforma" },
      { name: "description", content: "Plataforma de treino personalizado com acompanhamento profissional." },
      { property: "og:title", content: "Personal Trainer — Plataforma" },
